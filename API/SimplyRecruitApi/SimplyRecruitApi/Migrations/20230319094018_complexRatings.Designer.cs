...
namespace SimplyRecruitAPI.Migrations
{
    ...
    [Migration("20230319094018_complexRatings")]
    partial class complexRatings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimplyRecruitAPI.Auth.Model.SimplyUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SimplyRecruitAPI.Data.Entities.Application", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SimplyRecruitAPI.Data.Entities.Project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SimplyRecruitAPI.Data.Entities.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SimplyRecruitAPI.Data.Entities.Resume", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SimplyRecruitAPI.Auth.Model.SimplyUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SimplyRecruitAPI.Data.Entities.Application", b =>
                {
                    b.HasOne("SimplyRecruitAPI.Data.Entities.Position", "Position")
                        .WithMany()
            ...
            modelBuilder.Entity("SimplyRecruitAPI.Data.Entities.Position", b =>
                {
                    b.HasOne("SimplyRecruitAPI.Data.Entities.Project", "Project")
                        .WithMany()
