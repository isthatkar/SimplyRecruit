...
{
    public record PositionDto(int Id, string Name, string? Description, DateTime DeadLine, bool IsOpen, Location Location, WorkTime WorkTime, Field Field, int ProjectId, string SalaryRange, string Duties, string Expectations, string Offers);
