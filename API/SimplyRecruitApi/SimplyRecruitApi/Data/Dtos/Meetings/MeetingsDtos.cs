...
namespace SimplyRecruitAPI.Data.Dtos.Meetings
{
    ...
    public record UpdateMeetingDto(string? Title, string? Description, DateTime? FinalTime, bool? IsFinalTime, string? Attendees, DateTime[]? NewMeetingTimes, int? Duration, string? MeetingUrl, bool? IsCanceled);
