...
namespace SimplyRecruitAPI.Data.Dtos.Applications
{
    ...
    {
        public record ApplicationDto(int Id, string FullName, string PhoneNumber, string? ProfileUrl, string? CoverLetter, string ContactEmail, Stage Stage, int PositionId, string UserId, string PositionName);
        public record PositionApplicationDto(int Id, string FullName, string PhoneNumber, string? ProfileUrl, string? CoverLetter, string ContactEmail, Stage Stage, string UserId, string PositionName);
